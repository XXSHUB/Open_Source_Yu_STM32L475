 ...
 * Project:      USB Full/Low-Speed Host Driver for ST STM32L4xx
 * --------------------------------------------------------------------------
 ...
 *
 * Notes:
 *   - provide USBH_VbusOnOff function to use custom VBUS driving
 *   - provide USBH_GetOC function to use custom over-current status detection
 * -------------------------------------------------------------------------- */
...
/*! \page stm32l4_usbh CMSIS-Driver USBH_OTG Setup

The CMSIS-Driver USBH_OTG requires:
...
static const uint32_t *OTG_DFIFO[] = { (uint32_t *)(USB_OTG_FS_PERIPH_BASE + USB_OTG_FIFO_BASE                            ),
                                       ...
                                       (uint32_t *)(USB_OTG_FS_PERIPH_BASE + USB_OTG_FIFO_BASE + ( 8U * USB_OTG_FIFO_SIZE)),
                                       (uint32_t *)(USB_OTG_FS_PERIPH_BASE + USB_OTG_FIFO_BASE + ( 9U * USB_OTG_FIFO_SIZE)),
                                       (uint32_t *)(USB_OTG_FS_PERIPH_BASE + USB_OTG_FIFO_BASE + (10U * USB_OTG_FIFO_SIZE)),
                                       (uint32_t *)(USB_OTG_FS_PERIPH_BASE + USB_OTG_FIFO_BASE + (11U * USB_OTG_FIFO_SIZE))
                                     };
