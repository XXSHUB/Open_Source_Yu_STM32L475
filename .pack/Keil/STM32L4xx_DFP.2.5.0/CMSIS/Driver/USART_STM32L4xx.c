 ...
 * $Revision:    V1.3
 *
 * Driver:       (Synchronous mode only)
 *               Driver_USART1, Driver_USART2, Driver_USART3
 *
 ...
 *    Corrected Data bits configuration
 *  Version 1.0
 *    Initial release
 */

/*! \page stm32l4_usart CMSIS-Driver USART Setup
...
-----------------
  1. Under Connectivity open \b USART1 Configuration:
     ...
     - <b>GPIO Settings</b>: review settings, no changes required
          ...
          PB5      | USART1_CK     | Alternate | No pull-up and no..| Very High   |.
